...
function isGlobal(variable) {
  console.log(`isGlobal ${inspect(arguments, { depth: 1 })}`);
...
function getEnclosingFunctionScope(scope) {
  console.log(`getEnclosingFunctionScope ${inspect(arguments, { depth: 1 })}`);
...
function isReferencedInClosure(variable) {
  console.log(`isReferencedInClosure ${inspect(arguments, { depth: 1 })}`);
...
function isLoopAssignee(node) {
  console.log(`isLoopAssignee ${inspect(arguments, { depth: 1 })}`);
  return (
...
function isDeclarationInitialized(node) {
  console.log(`isDeclarationInitialized ${inspect(arguments, { depth: 1 })}`);
...
function getScopeNode(node) {
  console.log(`getScopeNode ${inspect(arguments, { depth: 1 })}`);
...
function isRedeclared(variable) {
  console.log(`isRedeclared ${inspect(arguments, { depth: 1 })}`);
...
function isUsedFromOutsideOf(scopeNode) {
  console.log(`isUsedFromOutsideOf ${inspect(arguments, { depth: 1 })}`);
  ...
  function isOutsideOfScope(reference) {
    console.log(`isOutsideOfScope ${inspect(arguments, { depth: 1 })}`);
...
function hasReferenceInTDZ(node) {
  console.log(`hasReferenceInTDZ ${inspect(arguments, { depth: 1 })}`);
...
function hasNameDisallowedForLetDeclarations(variable) {
  console.log(`hasNameDisallowedForLetDeclarations ${inspect(arguments, { depth: 1 })}`);
...
module.exports = {
  ...
  create(context) {
    console.log(`create ${inspect(arguments, { depth: 1 })}`);
    ...
    function hasSelfReferenceInTDZ(declarator) {
      console.log(`hasSelfReferenceInTDZ ${inspect(arguments, { depth: 1 })}`);
      if (!declarator.init) {
        return false;
      }
    ...
    function canFix(node) {
      console.log(`canFix ${inspect(arguments, { depth: 1 })}`);
    ...
    function report(node) {
      console.log(`report ${inspect(arguments, { depth: 1 })}`);
      context.report({
        node,
        messageId: 'unexpectedVar',

        fix(fixer) {
          console.log(`fix ${inspect(arguments, { depth: 1 })}`);
