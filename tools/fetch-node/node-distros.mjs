...
export default [
  {
    ...
    artifactoryUrl: `https://repox.jfrog.io/ui/native/nodejs-dist/${NODE_VERSION}/node-${NODE_VERSION}-win-x64.zip`,
  ...
  },
  {
    ...
    artifactoryUrl: `https://repox.jfrog.io/ui/native/nodejs-dist/${NODE_VERSION}/node-${NODE_VERSION}-darwin-arm64.tar.gz`,
  ...
  },
  {
    ...
    artifactoryUrl: `https://repox.jfrog.io/ui/native/nodejs-dist/${NODE_VERSION}/node-${NODE_VERSION}-linux-x64.tar.gz`,
