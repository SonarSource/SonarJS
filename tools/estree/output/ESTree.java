...
public class ESTree {
  ...
  public record ArrowFunctionExpression(Location loc, boolean expression, Node body, List<Pattern> params, boolean generator, boolean async) implements Expression {}
  ...
  public record ForInStatement(Location loc, Node left, Expression right, Statement body) implements Statement {}
  public record ForOfStatement(Location loc, boolean await, Node left, Expression right, Statement body) implements Statement {}
  public record ForStatement(Location loc, Node init, Expression test, Expression update, Statement body) implements Statement {}
  ...
  public record Identifier(Location loc, String name) implements Pattern {}
  ...
  public record MemberExpression(Location loc, Node object, Node property, boolean computed, boolean optional) implements Pattern {}
  ...
  public record NewExpression(Location loc, Node callee, List<Node> arguments) implements Expression {}
  ...
  public record SimpleCallExpression(Location loc, boolean optional, Node callee, List<Node> arguments) implements ChainElement {}
