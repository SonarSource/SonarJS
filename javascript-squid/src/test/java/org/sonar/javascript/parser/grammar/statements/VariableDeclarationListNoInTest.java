...
public class VariableDeclarationListNoInTest {
  ...
  @Before
  public void init() {
    p.setRootRule(g.variableDeclarationListNoIn);
  }
  ...
  public void ok() {
    ...
    assertThat(p, parse("variableDeclarationNoIn"));
    assertThat(p, parse("variableDeclarationNoIn , variableDeclarationNoIn"));
  }
