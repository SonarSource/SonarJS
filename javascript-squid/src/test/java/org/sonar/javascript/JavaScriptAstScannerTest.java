...
public class JavaScriptAstScannerTest {
  ...
  public void functions() {
    ...
    assertThat(file.getInt(EcmaScriptMetric.FUNCTIONS)).isEqualTo(5);
    assertThat(file.getInt(EcmaScriptMetric.STATEMENTS)).isEqualTo(7);
  }

  @Test
  public void complexity() {
    SourceFile file = JavaScriptAstScanner.scanSingleFile(new File("src/test/resources/metrics/complexity.js"));
    assertThat(file.getInt(EcmaScriptMetric.COMPLEXITY)).isEqualTo(13);
  }
