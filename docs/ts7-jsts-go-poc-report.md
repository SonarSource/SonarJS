...
> - the local Go implementation surface later grew from the original 7-rule pilot to 60 Sonar keys, while current product routing is intentionally restricted to the 17 hard type-service rules in `JSTS_GO_RULES`
