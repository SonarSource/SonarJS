...
| **bridge**                  | `Clean autogenerated modules`    | `git clean -xdf packages/analysis/src/jsts/rules/` | Removes `generated-meta.ts` files   |
...
| ---------- | -------------------------------- | --------------------- | --------------------------------------------------------------------------------------------------- |
| **bridge** | `Generate Protobuf Java Sources` | protobuf-maven-plugin | Compiles `packages/analysis/src/jsts/parsers/*.proto` → Java classes in `target/generated-sources/` |
...
│   └── Generates packages/analysis/src/jsts/rules/*/generated-meta.ts
...
│ Output: packages/analysis/src/jsts/rules/SXXXX/generated-meta.ts                         │
│ Git status: GITIGNORED                                                          │
└─────────────────────────────────────────────────────────────────────────────────┘
```
...
| `packages/analysis/src/jsts/rules/*/generated-meta.ts`                                          | Gitignored    | Generated ESLint metadata     |
...
| `packages/analysis/src/jsts/rules/*/generated-meta.ts`                                                                | No                  | Yes                    |
| `lib/`                                                                                                                | No                  | Yes                    |
...
The protobuf files in `packages/analysis/src/jsts/parsers/` define the communication protocol between the Java plugin and the Node.js bridge. Both Java and TypeScript code is generated from these definitions.
