...
`sanitizeProjectAnalysisInput()` performs the main boundary crossing for the
analyze-project runtime:

- validates the raw JSON payload shape,
- creates a sanitized `Configuration` via `createConfiguration()`,
...
| ----------------------------- | ----------------------------------------- | ------------------------------------------------------------------ |
| Analyze-project `requestJson` | `Configuration` + initialized file stores | `sanitizeProjectAnalysisInput()`, `createConfiguration()`          |
...
| raw configuration objects     | validated `Configuration`                 | `createConfiguration()`                                            |
