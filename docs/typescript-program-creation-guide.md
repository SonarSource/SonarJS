...
const parsed = ts.parseJsonConfigFileContent(
  { compilerOptions: { target: 'ES2020', allowJs: true, noEmit: true } },
  ts.sys,
  'c:/www/projects/SonarJS/packages/analysis/jsts',
  {},
  'c:/www/projects/SonarJS/packages/analysis/jsts/tsconfig.json', // Inside process.cwd()
);
...
- @types searches: **1,537+ attempts**
  - `c:/www/projects/SonarJS/packages/analysis/jsts/node_modules/@types` → false
  - `c:/www/projects/SonarJS/node_modules/@types` → true ✓
...
| C        | `c:/www/projects/SonarJS/packages/analysis/jsts/tsconfig.json` | `c:/www/projects/SonarJS/packages/analysis/jsts/` | ✓ Yes              | 11,996       |
