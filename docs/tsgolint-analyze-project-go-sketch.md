# `tsgolint` Analyze-Project Go Sketch
...
This document turns the gap analysis in [node-vs-tsgolint-equivalence-assessment.md](/C:/Users/victor.diez/projects/SonarJS/docs/node-vs-tsgolint-equivalence-assessment.md) into a concrete Go-side starting point.

The intent is to answer one question:

What should the first real Go refactor look like if we want `tsgolint` to progressively match the Node.js `analyze-project` endpoint semantics?
...
Today the Go side does this in [service.go](/C:/Users/victor.diez/projects/SonarJS/sonar-plugin/bridge/src/main/go/sonar-server/service.go:87):
...
Keep the implementation in `sonar-plugin/bridge/src/main/go/sonar-server`.
...
- [service.go](/C:/Users/victor.diez/projects/SonarJS/sonar-plugin/bridge/src/main/go/sonar-server/service.go): RPC wiring + top-level orchestration
- [requested_rules.go](/C:/Users/victor.diez/projects/SonarJS/sonar-plugin/bridge/src/main/go/sonar-server/requested_rules.go): rule option conversion and Sonar defaults
- [converter.go](/C:/Users/victor.diez/projects/SonarJS/sonar-plugin/bridge/src/main/go/sonar-server/converter.go): issue/result conversion
- [rules.go](/C:/Users/victor.diez/projects/SonarJS/sonar-plugin/bridge/src/main/go/sonar-server/rules.go): available rules and Sonar key mapping
...
This should be the output of the current [requested_rules.go](/C:/Users/victor.diez/projects/SonarJS/sonar-plugin/bridge/src/main/go/sonar-server/requested_rules.go:34) logic plus the missing request fields already used by Node for filtering.
...
Use the existing overlay VFS support in [overlay_vfs.go](/C:/Users/victor.diez/projects/SonarJS/tsgolint/internal/utils/overlay_vfs.go:14) and make it part of the standard request path.
