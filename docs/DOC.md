...
### <a name="eslint"></a>Import of ESLint issues
SonarJS provides an import into SonarQube of issues generated by ESLint. For that run your ESLint with JSON formatter and forward the results to some file. Here is an example of command generating required report.
```
