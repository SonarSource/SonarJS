...
public class FileCognitiveComplexityTest {

  private FileCognitiveComplexityCheck check = new FileCognitiveComplexityCheck();

  @Test
  public void test() {
    JavaScriptCheckVerifier.verify(check, new File("src/test/resources/checks/file_level_cognitive_complexity.js"));
  }

  private class FileCognitiveComplexityCheck extends DoubleDispatchVisitorCheck {
