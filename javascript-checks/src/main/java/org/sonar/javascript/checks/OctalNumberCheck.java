...
public class OctalNumberCheck extends SquidCheck<EcmaScriptGrammar> {

  @Override
  public void init() {
    subscribeTo(getContext().getGrammar().numericLiteral);
  }
  ...
  public void visitNode(AstNode astNode) {
    ...
    if (value.startsWith("0")) {
      int newValue = Integer.parseInt(value, 8);
