...
import { rule as NoSingleCharInCharacterClassesCheck } from './no-single-char-in-character-classes';
...
ruleModules['no-single-char-in-character-classes'] = NoSingleCharInCharacterClassesCheck;
