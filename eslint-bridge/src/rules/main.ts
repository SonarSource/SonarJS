...
import { rule as noCollectionSizeMischeck } from "./no-collection-size-mischeck";
import { rule as noConditionalAssignment } from "./no-conditional-assignment";
...
ruleModules["no-collection-size-mischeck"] = noCollectionSizeMischeck;
ruleModules["no-conditional-assignment"] = noConditionalAssignment;
