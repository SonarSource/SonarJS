 ...
 */
import { rule } from 'rules/deprecation';
...
ruleTester.run('should report usages of deprecated', rule, {
  ...
  import defaultImport, {deprecatedFunction, anotherDeprecatedFunction as aliasForDeprecated, notDeprecated1, notDeprecated2} from './deprecations';
  ...
  import * as deprecationsExport from './deprecationsExport';
  foo(deprecationsExport); // Noncompliant
  
  import {DeprecatedClass, ClassWithDeprecatedConstructor, ClassWithOneDeprecatedConstructor} from "./deprecations"
