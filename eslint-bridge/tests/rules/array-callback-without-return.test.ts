...
const ruleTesterWithoutTypes = new RuleTester({
  parserOptions: { ecmaVersion: 2018, sourceType: 'module' },
});

import { rule } from 'rules/array-callback-without-return';

ruleTesterTs.run('Callbacks of array methods should have return statements [w types]', rule, {
  valid: [
    {
      code: `
      const arr = [];
