...
import { decorateNewCap } from './new-cap-decorator';
...
import { decoratePreferSpread } from './prefer-spread-decorator';
...
export const decorators: Record<string, RuleDecorator> = {
  ...
  'prefer-spread': decoratePreferSpread,
