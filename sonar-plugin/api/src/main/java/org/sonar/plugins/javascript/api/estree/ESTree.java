...
public class ESTree {
  ...
  public sealed interface ImportDefaultSpecifierOrImportNamespaceSpecifierOrImportSpecifier
    extends Node {}
  ...
  public record ForStatement(
    Location loc,
    Optional<ExpressionOrVariableDeclaration> init,
  ...
  public record Identifier(Location loc, String name) implements
    Expression, Pattern, IdentifierOrLiteral {}
  ...
  public enum UnaryOperator implements Operator {
    ...
    public static UnaryOperator from(String operator) {
      return Arrays.stream(values())
        .filter(v -> Objects.equals(operator, v.raw))
        .findFirst()
        .orElse(null);
    }
  }
