...
class ESTreeTest {
  ...
  void test_node_subclasses() {
    ...
    assertThat(permittedSubclasses).hasSize(36);
  }
  ...
  void test_expression_subclasses() {
    ...
    Class<?>[] permittedSubclasses = sealedClass.getPermittedSubclasses();
    assertThat(permittedSubclasses).hasSize(27);
  }
