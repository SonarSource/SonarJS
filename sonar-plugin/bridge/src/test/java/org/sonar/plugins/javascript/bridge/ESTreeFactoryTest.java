...
class ESTreeFactoryTest {
  ...
  void should_not_fail_with_unknown_nodes() throws IOException {
    // the clear version of serialized.proto is `packages/analysis/jsts/tests/parsers/fixtures/ast/unknownNode.ts`,
    // it was generated by writing to a file the serialized data in the test `packages/analysis/jsts/tests/parsers/ast.test.ts`
  ...
  void should_create_nodes_from_serialized_data() throws IOException {
    // the clear version of serialized.proto is `packages/analysis/jsts/tests/parsers/fixtures/ast/base.js`,
    // it was generated by writing to a file the serialized data in the test `packages/analysis/jsts/tests/parsers/ast.test.ts`
