...
class ESTreeFactoryTest {
  ...
  void should_not_fail_with_unknown_nodes() throws IOException {
    // the clear version of serialized.proto is `packages/analysis/tests/jsts/parsers/fixtures/ast/unknownNode.ts`,
    // it was generated by writing to a file the serialized data in the test `packages/analysis/tests/jsts/parsers/ast.test.ts`
    File file = resolveTestFile("unknown.proto").toFile();
  ...
  void should_create_nodes_from_serialized_data() throws IOException {
    ...
    // it was generated by writing to a file the serialized data in the test `packages/analysis/tests/jsts/parsers/ast.test.ts`
    File file = resolveTestFile("serialized.proto").toFile();
