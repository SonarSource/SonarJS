 ...
 *
 * Checks the declared type (ignoring control flow narrowing) because if a symbol
 * is declared nullable, a non-null assertion is meaningful even after type guards.
 */
