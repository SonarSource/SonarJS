...
test('should do something', { skip: 'There is a bug in the code' }, function (t) {
  // Compliant
  t.assert.ok(true);
});

test('should do something', { skip: true }, function (t) {
  // Noncompliant {{Remove this unit test or explain why it is ignored.}}
  //                            ^^^^^^^^^^
  t.assert.ok(true);
});

test('should do something', { skip: '' }, function (t) {
  // Noncompliant
  t.assert.ok(true);
});
