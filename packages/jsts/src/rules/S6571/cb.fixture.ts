...
type D = false & boolean; // Noncompliant {{boolean is overridden by false in this intersection type.}}
type E = FALSE & boolean; // Noncompliant {{boolean is overridden by false in this intersection type.}}
...
type H = 0 & number; // Noncompliant {{number is overridden by 0 in this intersection type.}}
type I = ZERO & number; // Noncompliant {{number is overridden by 0 in this intersection type.}}
type J = '' & string; // Noncompliant {{string is overridden by "" in this intersection type.}}
type K = 0n & bigint; // Noncompliant {{bigint is overridden by 0n in this intersection type.}}
