...
export type DesugaredProgramStatement = Exclude<TSESTree.ProgramStatement, TSESTree.Statement>
  | DesugaredStatement
  ;

export type DesugaredStatement = Exclude<TSESTree.Statement,
...
export type DesugaredNode = Exclude<TSESTree.Node,
    | TSESTree.Program
