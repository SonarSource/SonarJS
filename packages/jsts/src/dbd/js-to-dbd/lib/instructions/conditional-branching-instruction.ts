...
import {type BaseTerminatorInstruction, createTerminatorInstruction} from "./terminator-instruction";
import type {Value} from "../value";
import type {Location} from "../location";

export type ConditionalBranchingInstruction = BaseTerminatorInstruction<"conditional_branching", [Value]> & {
