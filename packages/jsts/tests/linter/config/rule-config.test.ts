...
import { setContext } from '@sonar/shared/index.ts';
import { extendRuleConfig, RuleConfig } from '../../../src/linter/config/index.ts';
import { SONAR_CONTEXT, SONAR_RUNTIME } from '../../../src/linter/parameters/index.ts';
