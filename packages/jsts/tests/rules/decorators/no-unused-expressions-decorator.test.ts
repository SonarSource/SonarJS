...
import { decorateNoUnusedExpressions } from '../../../src/rules/decorators/no-unused-expressions-decorator';
...
const rule = decorateNoUnusedExpressions(typescriptESLintRules['no-unused-expressions']);
