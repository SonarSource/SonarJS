...
import { decorateNoDuplicateImports } from '../../../src/rules/decorators/no-duplicate-imports-decorator';

const ruleTester = new RuleTester({
  parser: require.resolve('@typescript-eslint/parser'),
  parserOptions: { ecmaVersion: 2018, sourceType: 'module' },
});
const rule = decorateNoDuplicateImports(typescriptESLintRules['no-duplicate-imports']);
