...
**Rules using this pattern:** S1874, S4649, S4653, S4654, S4659, S4660, S4662, S4670, S8759, S8776, S8777 (11 rules)
...
**Rules using this pattern:** S125, S1116, S1128, S4647, S4648, S4650, S4651, S4652, S4655, S4657, S4658, S4661, S4663, S4664, S4666, S4667, S4668, S5362, S7923, S7924, S7925, S8765, S8769, S8770, S8775 (25 rules)
...
| ------------- | ----- | ---------------------------- | -------------------------------- |
| No params     | 25    | Rule enabled with defaults   | `true`                           |
| Ignore params | 11    | Comma-separated string lists | `[true, { key: ['v1', 'v2'] }]`  |
| Boolean param | 1     | Conditional fixed options    | `[true, { key: ['v'] }]` or `[]` |

**Total: 37 CSS rules (12 with configurable parameters)**
