...
import type { ESLintConfiguration } from '../../../../analysis/jsts/src/rules/helpers/configs.js';
 ...
 * metadata from `packages/analysis/jsts/src/rules/metas.js`. Each rule's `meta.ts` file
