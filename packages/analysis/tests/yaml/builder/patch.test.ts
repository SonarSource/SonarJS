...
import { JsTsAnalysisInput, JSTS_ANALYSIS_DEFAULTS } from '../../../src/jsts/analysis/analysis.js';
import { build as buildJsTs } from '../../../src/jsts/builders/build.js';
import { type EmbeddedJS } from '../../../src/contracts/embedded.js';
import { patchParsingErrorMessage } from '../../../src/jsts/embedded/builder/patch.js';
import { readFile, normalizeToAbsolutePath } from '../../../../shared/src/helpers/files.js';
import { parseAwsFromYaml } from '../../../src/yaml/aws/parser.js';
