 ...
 */
import type { Location } from '../../../../src/jsts/analysis/file-artifacts.js';
import path from 'node:path';
import { parseTypeScriptSourceFile } from '../../tools/helpers/parsing.js';
import { describe, it } from 'node:test';
import { expect } from 'expect';
import { collectTestFileArtifacts } from '../../../../src/jsts/analysis/file-artifacts.js';
import type { SymbolHighlight } from '../../../../src/jsts/analysis/file-artifacts.js';

describe('collectTestFileArtifacts (symbol highlights)', () => {
