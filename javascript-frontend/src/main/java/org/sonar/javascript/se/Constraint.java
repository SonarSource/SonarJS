...
public class Constraint {
  ...
  public static final Constraint TRUTHY = or(TRUE, POSITIVE_NUMBER_PRIMITIVE, NEGATIVE_NUMBER_PRIMITIVE, TRUTHY_STRING_PRIMITIVE, KNOWN_OBJECTS, OTHER_OBJECT);
  public static final Constraint FALSY = TRUTHY.not();
  public static final Constraint NUMBER_PRIMITIVE = or(ZERO, NAN, POSITIVE_NUMBER_PRIMITIVE, NEGATIVE_NUMBER_PRIMITIVE);
