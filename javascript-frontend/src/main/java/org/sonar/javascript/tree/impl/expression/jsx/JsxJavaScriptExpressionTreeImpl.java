...
public class JsxJavaScriptExpressionTreeImpl extends JavaScriptTree implements JsxJavaScriptExpressionTree {

  private final InternalSyntaxToken lCurlyBraceToken;
  private final ExpressionTree expression;
  private final InternalSyntaxToken rCurlyBraceToken;

  public JsxJavaScriptExpressionTreeImpl(InternalSyntaxToken lCurlyBraceToken, @Nullable ExpressionTree expression, InternalSyntaxToken rCurlyBraceToken) {
  ...
  @Override
  public Kind getKind() {
    return Kind.JSX_JAVASCRIPT_EXPRESSION;
  }

  @Override
  public Iterator<Tree> childrenIterator() {
    return Iterators.forArray(lCurlyBraceToken, expression, rCurlyBraceToken);
  }
  ...
  public void accept(DoubleDispatchVisitor visitor) {
    visitor.visitJsxJavaScriptExpression(this);
  }
}
