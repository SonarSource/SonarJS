...
public class JsxEmptyOpeningElementTreeImpl extends JavaScriptTree implements JsxEmptyOpeningElementTree {

  private final SyntaxToken ltToken;
  private final SyntaxToken gtToken;

  public JsxEmptyOpeningElementTreeImpl(SyntaxToken ltToken, SyntaxToken gtToken) {
  ...
  @Override
  public Kind getKind() {
    return Kind.JSX_EMPTY_OPENING_ELEMENT;
  }

  @Override
  public Iterator<Tree> childrenIterator() {
    return Iterators.forArray(ltToken, gtToken);
  }
  ...
  public void accept(DoubleDispatchVisitor visitor) {
    visitor.visitJsxEmptyOpeningElement(this);
  }
}
