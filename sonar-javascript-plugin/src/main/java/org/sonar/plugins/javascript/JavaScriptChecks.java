...
public class JavaScriptChecks extends AbstractChecks {
   ...
   */
  public JavaScriptChecks(CheckFactory checkFactory, CustomJavaScriptRulesDefinition[] customRulesDefinitions) {
    this(checkFactory, customRulesDefinitions, null);
  }
   ...
   * See plugin integration tests
   */
  public JavaScriptChecks(CheckFactory checkFactory, CustomRuleRepository[] customRuleRepositories) {
