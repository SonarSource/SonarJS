...
public class JavaScriptPluginException extends Exception {
  ...
  public JavaScriptPluginException(String s) {
    super(s);
  }

  public JavaScriptPluginException(String s, Throwable throwable) {
    super(s, throwable);
  }

  public JavaScriptPluginException(Throwable throwable) {
    super(throwable);
  }
}
