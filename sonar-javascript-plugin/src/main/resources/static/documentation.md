...
the latest available LTS version (v16 as of today) for optimal stability and performance. v10 and v12 are still supported, but they already reached end-of-life and
are deprecated.
