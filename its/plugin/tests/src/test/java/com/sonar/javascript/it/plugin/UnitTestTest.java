...
public class UnitTestTest {
  ...
  public void jstestdriver_report_path_can_be_relative() {
    SonarRunner build = Tests.createSonarRunnerBuild()
      ...
      .setSourceDirs("main")
      .setTestDirs("test")
      .setProperty("sonar.javascript.jstestdriver.reportsPath", "reports/jstestdriver");
  ...
  public void jstestdriver_report_path_can_be_absolute() {
    SonarRunner build = Tests.createSonarRunnerBuild()
      ...
      .setSourceDirs("main")
      .setTestDirs("test")
      .setProperty("sonar.javascript.jstestdriver.reportsPath", TestUtils.file("projects/unittest/reports/jstestdriver").getAbsolutePath());
    orchestrator.executeBuild(build);
  ...
  public void jestestdriver_report_with_unknown_classname() {
    SonarRunner build = Tests.createSonarRunnerBuild()
      ...
      .setSourceDirs("main")
      .setTestDirs("test")
      .setProperty("sonar.javascript.jstestdriver.reportsPath", TestUtils.file("projects/unittest/reports/jstestdriver-unknown-file").getAbsolutePath());
